  ...
  <div class="row">
    ...
    <main id="main" class="col-xs-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div  id="contenedorform">
              ...
              <hr>
          <form class="row" action="../controladores/insertarconfirmacion.php" method="POST">
                ...
                <div class="form-row align-items-center">
                  ...
                  <div class="input-group col-md-12">
                      ...
                      <span class="input-group"></span>
                    	<select id="buscadorn" style="width: 82.5%" name="sacramentado">
                  ...
                  <div class="input-group col-md-12">
                      ...
                      <span class="input-group"></span>
                    	<select id="buscadorob" style="width: 86.5%" name="obispo">
                      <option value="0" selected  >Buscar nombre</option>
                        <?php
                      ...
                      <button type="button" class="btn btn-primary btn-sm" id="btnobispo">
                        Registrar Obispo
                      </button>
                  </div>
                  ...
                  <div class="input-group col-md-12">
                      ...
                      <span class="input-group"></span>
                    	<select id="buscadorpd" style="width: 86%" name="padrinou">
                      <option value="0" selected  >Buscar nombre</option>
                        <?php
                  ...
                  <div class="input-group col-md-12">
                      ...
                      <span class="input-group"></span>
                    	<select id="buscadorpdd" style="width: 86%" name="padrinod">
                      <option value="0" selected  >Buscar nombre</option>
                        <?php
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
              <form action="../controladores/insertarsacramentadoconfirmacion.php" method="POST">
...
<!-- Modal obispo -->
<div class="modal fade" id="mobispo" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Registrar Obispo</h5>
        <button type="button" class="btn btn-danger btn-sm" id="btncerraro">
        <span data-feather="x"></span>
        </button>
      </div>
      <div class="modal-body">
              <form action="../controladores/insertarObispoconfirmacion.php" method="POST">

             

                <label for="inputAddress">Nombre del Obispo:</label>
                <input type="text" class="form-control" id="" placeholder="Nombre" name="obispo"> 
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" id="btncerraro2">Cerrar</button>
        <button type="submit" class="btn btn-primary">Registrar</button>
      </div>
      </form>
    </div>
...
<div class="modal fade" id="mpadrino" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form action="../controladores/insertarPadrinoconfirmacion.php" method="POST">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
      ...
      $("#btnobispo").click(function(){
        $('#mobispo').modal('show');
      });  

      $("#btncerraro").click(function(){
        $("#mobispo").modal("hide");
      });

      $("#btncerraro2").click(function(){
        $("#mobispo").modal("hide");
      });
