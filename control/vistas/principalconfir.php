        ...
        <div class ="row">
          ...
          <h3>Confirmación</h3>
           ...
           <div class="btn-group mr-2" role="group" aria-label="Third group">
                <a class="btn btn-primary  btn-sm" href="actconfir.php" role="button"> <span data-feather="plus"></span> Registrar Confirmación</a>
                </div>

                <div style="width: 3px;"></div>

                <div class="btn-group mr-2" role="group" aria-label="Third group">
                <a class="btn btn-primary  btn-sm" href="actsupconfir.php" role="button"> <span data-feather="plus"></span> Registrar supletoria de Confirmación</a>
                </div>
           </div>    
        ...
        <table id="formato" class="table table-striped "  style="width:100%">
            ...
            <?php 
              ...
              //codigo llenar tabla
                ...
                reg.testimonioPersona,reg.edadSacramento, sac.nombre,daper.nombre as papa, dapers.nombre as mama,dper.nombre as obispo
               ...
               WHERE reg.Sacramentos_idSacramentos = 3  order by reg.fechaSacramento desc";
                ...
                $resul = mysqli_query($conn,$consu);
                      ...
                      while($row = mysqli_fetch_array($resul)){
                        ...
                        <tr>
                          ...
                          <td><?php if(!empty($row['obispo'])){echo $row['obispo'];}else{echo "No ingresado";} ?></td>
                ...
                <div class="btn-group mr-2" role="group" aria-label="Third group">
                  ...
                  data-nsuple="<?php echo $row['noSupletoria'] ?>" data-edad="<?php echo $row['edadSacramento'] ?>"
                  data-testi="<?php echo $row['testimonioPersona'] ?>" >
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
              <form target="_blank" action="../controladores/pdfconfirmacion.php" method="POST">
      <input type="text" hidden class="form-control" id="idcon" placeholder="" name="idconfirmacion">
...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #FFCE54;">
        <h5 class="modal-title" id="exampleModalLongTitle">Editar acta de Confirmación</h5>
        <button type="button" class="btn btn-danger btn-sm" id="cerrar">
        <span data-feather="x"></span>
        </button>
      </div>
      <div class="modal-body">
        <form action="../controladores/editarconfir.php" method="POST">
      ...
      <div class="form-group col-md-6">
              ...
              <div class="form-row">
                <div class="form-row align-items-center">
                  ...
                  <div class="input-group col-md-12">
                      <label for="inputAddress">Obispo:</label>
                      <span class="input-group"></span>
                      <select class="form-select" aria-label="Default select example" name="obispo">
                      <option value="0" selected  >Buscar nombre</option>
                        <?php
                       ...
                       $selectd = "SELECT per.idPersona, per.TipoPersona_idTipoPersona, dp.nombre  FROM persona as per
                                   ...
                                   WHERE TipoPersona_idTipoPersona = 5 and estado = 1 ORDER BY nombre ASC";
...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #FFCE54;">
        <h5 class="modal-title" id="exampleModalLongTitle">Editar Supletoria de Confirmación</h5>
        <button type="button" class="btn btn-danger btn-sm" id="cerrarsupled">
        <span data-feather="x"></span>
        </button>
      </div>
      <div class="modal-body">
        <form action="../controladores/editarsupconfir.php" method="POST">
              ...
              <div class="form-row">
                <div class="form-row align-items-center">
                  ...
                  <div class="input-group mb-1">
                    <input type="number" class="form-control" placeholder="Edad" name="edad" id="edads">
