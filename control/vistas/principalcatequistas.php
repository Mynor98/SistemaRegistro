  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
              <form action="../controladores/insertarCatequista.php" method="POST">
...
<div class="modal fade" id="modaleditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
              <form action="../controladores/modificarCatequista.php" method="POST">
              <input type="text" hidden class="form-control" id="idcat" placeholder="Nombre" name="idcat">
...
<script type="text/javascript">
  ...
  $(document).on("click", "#btnmodalcat", function (){
