...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="container col-lg-10" style=" background-color: white; padding-top: 20px; padding-bottom: 20px; border-radius: 20px;" >
        ...
        if($usuariorol == 1 || $usuariorol == 2){
            ...
            <span data-feather='user-plus'></span> Registrar Padre
            </button>";
          }
          ?>
                </div>
  ...
  <?php 
     ...
     //codigo llenar tabla
      ...
      WHERE per.TipoPersona_idTipoPersona = 1 and per.estado = 1 ";
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Registrar Padre</h5>
        <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal" aria-label="Close">
        <span data-feather="x"></span>
        </button>
      </div>
      <div class="modal-body">
           <form action="../controladores/insertarPadre.php" method="POST">

      <label for="inputAddress">Nombre del Padre o madre:</label>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #FFCE54;">
        <h5 class="modal-title" id="exampleModalLongTitle">Editar Padre</h5>
        <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal" aria-label="Close">
        <span data-feather="x"></span>
        </button>
      </div>
      <div class="modal-body">
           <form action="../controladores/modificarPadre.php" method="POST">
...
<div class="modal fade" id="meliminar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../controladores/eliminarpadres.php" method="POST">
      <input type="text" hidden class="form-control" id="padreliminar" placeholder="Nombre" name="eidpadre">
        <center>
        <h6>¿Está seguro que desea eliminar al padre?</h6>
        </center>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
...
<script type="text/javascript">
  ...
  $(document).on("click", "#btneliminar", function (){
    var idepadr =$(this).data('ide');
 
    $("#padreliminar").val(idepadr);
