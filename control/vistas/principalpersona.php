    ...
    <div class="container col-lg-10" style=" background-color: white; padding-top: 20px; padding-bottom: 20px; border-radius: 20px;" >
        <div class ="row">
          <div class="col-lg-12">
            ...
            echo "<button type='button' class='btn btn-primary btn-sm' data-toggle='modal' data-target='#modalsac'>
  ...
  <?php 
     ...
     //codigo llenar tabla
      ...
      <div class='btn-toolbar' >
        ...
        data-id=".$row['idp']." data-nom=".$row['noms']." 
        data-lugn=".$row['lugn']." data-luga=".$row['luga']." >
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #FFCE54;"> 
        <h5 class="modal-title" id="exampleModalLongTitle">Editar Sacramentado</h5>
        <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal" aria-label="Close">
        <span data-feather="x"></span>
        </button>
      </div>
