  ...
  <div class="row">
    ...
    <main id="main" class="col-xs-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div  id="contenedorform">
              <h3>Registro supletoria de primera comunión</h3>
              <hr>
          <form class="row" action="../controladores/insertaractasupcomunion.php" method="POST">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
              <form action="../controladores/insertarsacramentadosupComunion.php" method="POST">
...
<div class="modal fade" id="msacerdote" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
              <form action="../controladores/insertarSacerdotecomunion.php" method="POST">
...
<div class="modal fade" id="mcatequista" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../controladores/insertarCatequistasupcomunion.php" method="POST">   
