...
<div class="container-fluid">
    ...
    <div class="container col-lg-10" style=" background-color: white; padding-top: 20px; padding-bottom: 20px; border-radius: 20px;" >
        <div class ="row">
          <div class="col-lg-12">
           ...
           <span data-feather="user-plus"></span>   Registrar Obispo
            </button>
                </div>
  ...
  <?php 
     ...
     //codigo llenar tabla
      ...
      WHERE per.TipoPersona_idTipoPersona = 5 and per.estado = 1";
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
              <form action="../controladores/insertarObispo.php" method="POST">
...
<div class="modal fade" id="modalmodificar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><u>Moificar Obispo</u></h5>
        <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal" aria-label="Close">
        <span data-feather="x"></span>
        </button>
      </div>
      <div class="modal-body">
              <form action="../controladores/modificarObispo.php" method="POST">
...
<div class="modal fade" id="meliminar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../controladores/eliminarObispo.php" method="POST">
      <input type="text" hidden class="form-control" id="saceeliminar" placeholder="Nombre" name="eidobispo">
        <center>
        <h6>¿Está seguro que desea eliminar al Obispo?</h6>
        </center>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
