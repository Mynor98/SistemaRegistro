    ...
    if(!empty($fecha)){
        ...
        if($sacramentado !=0){
            ...
            if($padrinou != 0 && $padrinod !=0){
                ...
                fechaSacramento = '$fecha',edadSacramento = $edad ,testimonioPersona = '$testigo' , Persona_idPadrinouno = $padrinou, 
                Persona_idPadrinodos = $padrinod, Sacramentados_idDatosPersona = $sacramentado
                ...
                where idRegistro = $idacta";
                   ...
                   window.location.href='../vistas/principalconfir.php';
                    ...
                    $sql = "UPDATE registro SET noLibro = $libro, noFolio = $folio,noSupletoria = $supletoria, 
                    fechaSacramento = '$fecha',edadSacramento = $edad ,testimonioPersona = '$testigo' ,
                    Persona_idPadrinodos = $padrinod, Sacramentados_idDatosPersona = $sacramentado
                    where idRegistro = $idacta";
